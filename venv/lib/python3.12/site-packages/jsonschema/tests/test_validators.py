...
class TestRefResolver(TestCase):
    ...
    def test_it_retrieves_local_refs_via_urlopen(self):
        ...
        ref = f"file://{pathname2url(tempf.name)}
        with self.resolver.resolving(ref) as resolved:
    ...
    def test_newly_created_validator_with_ref_resolver(self):
        """
        See https://github.com/python-jsonschema/jsonschema/issues/1061
        """
        def handle(uri):
    ...
    def test_refresolver_with_pointer_in_schema_with_no_id(self):
        """
        See https://github.com/python-jsonschema/jsonschema/issues/1124
        """
        schema = {
            "properties": {"x": {"$ref": "
