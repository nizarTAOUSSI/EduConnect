...
import { LayoutDashboard, LogOut, ChevronRight, Users, FileSpreadsheet, Clock, MessageSquare, Calendar, Bell } from 'lucide-react';
import { useAuth } from '../../hooks/useAuth';
import api from '../../api/axios';
import logo from '../../assets/Logo.png';

const NAV_ITEMS = [
  { name: 'Tableau de bord', path: '/dashboard/parent', icon: LayoutDashboard },
  { name: 'Mes Enfants', path: '/dashboard/parent/enfants', icon: Users },
  { name: 'Emploi du temps', path: '/dashboard/parent/timetable', icon: Calendar },
  { name: 'Notes des Enfants', path: '/dashboard/parent/notes', icon: FileSpreadsheet },
  { name: 'Absences', path: '/dashboard/parent/absences', icon: Clock },
  { name: 'Réclamations', path: '/dashboard/parent/reclamations', icon: MessageSquare },
  { name: 'Notifications', path: '/dashboard/parent/notifications', icon: Bell, isNotification: true },
];
              ...
              <div className="flex items-center gap-3">
                <div className="relative">
                  ...
                  {item.isNotification && unreadCount > 0 && (
                    <span className="absolute -top-1 -right-1 w-4 h-4 bg-purple-600 text-white text-[10px] font-black rounded-full flex items-center justify-center ring-2 ring-white animate-bounce">
