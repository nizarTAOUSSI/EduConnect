...
import { LayoutDashboard, Users, BookOpen, LogOut, ChevronRight, GraduationCap, UserCheck, Contact, School, Calendar, FileText, Bell, PanelLeftClose, PanelLeftOpen, Languages } from 'lucide-react';
...
export default function Sidebar() {
  ...
  const NAV_ITEMS = [
    { name: t('dashboard.sidebar.dashboard'), path: '/dashboard/admin', icon: LayoutDashboard },
    { name: t('dashboard.sidebar.users'), path: '/dashboard/admin/users', icon: Users },
    { name: t('dashboard.sidebar.teachers'), path: '/dashboard/admin/teachers', icon: UserCheck },
    { name: t('dashboard.sidebar.students'), path: '/dashboard/admin/students', icon: GraduationCap },
    { name: t('dashboard.sidebar.parents'), path: '/dashboard/admin/parents', icon: Contact },
              ...
              <div className="flex items-center gap-3">
                <div className="relative">
                  ...
                  {item.isNotification && unreadCount > 0 && (
                    <span className={`absolute -top-1 -right-1 w-4 h-4 bg-indigo-600 text-white text-[10px] font-black rounded-full flex items-center justify-center ring-2 ring-white ${isCollapsed ? '' : 'animate-bounce'}`}>
