  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-12">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-3xl font-black text-slate-900 tracking-tight uppercase">Dashboard Parent</h1>
          <p className="text-slate-500 mt-1 font-medium">
            Bienvenue, {user?.first_name}. Suivez la scolarité de vos enfants en temps réel.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <StatCard title="Mes Enfants" value={stats.enfants} icon={Users} color="bg-blue-600" />
        <StatCard title="Réclamations" value={stats.reclamations} icon={MessageSquare} color="bg-amber-600" />
        <StatCard title="Absences Total" value={stats.absences} icon={Clock} color="bg-rose-600" trend={stats.absences > 0 ? "À suivre" : "RAS"} />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white rounded-3xl border border-slate-200/60 p-8 shadow-sm">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-xl font-bold text-slate-900">Activité des enfants</h2>
          </div>
