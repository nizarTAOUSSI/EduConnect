...
export default function Features() {
  ...
  const features = [
    {
      title: t('features.global_accessibility.title'),
      description: t('features.global_accessibility.description'),
    ...
    {
      title: t('features.reliable_engine.title'),
      description: t('features.reliable_engine.description'),
    ...
    {
      title: t('features.fluid_communication.title'),
      description: t('features.fluid_communication.description'),
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          >
            ...
            <h3 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-6 tracking-tight">{t('features.title')}</h3>
